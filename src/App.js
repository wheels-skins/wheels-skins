...
export default function WheelsSkinsApp() {
  ...
  const leatherTextures = [
    ...
    { title: 'جلد فسفوري مضيء', desc: 'مظهر رياضي مشع وجريء', image: `${publicUrl}/textures/green.jpg`, fallback: wheelPlain, colorHex: '#39FF14' },
    { title: 'جلد وردي (بينك)', desc: 'لمسة عصرية مميزة وجذابة', image: `${publicUrl}/textures/pink.jpg`, fallback: wheelPlain, colorHex: '#FF10F0' },
    { title: 'جلد أصفر فسفوري', desc: 'إطلالة رياضية حماسية ساطعة', image: `${publicUrl}/textures/yellow.jpg`, fallback: wheelPlain, colorHex: '#CCFF00' }
  ];
